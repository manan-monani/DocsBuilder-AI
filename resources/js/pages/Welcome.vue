...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        <header class="absolute top-0 right-0 left-0 p-6 flex justify-between items-center z-10 max-w-7xl mx-auto w-full">
             <div class="flex gap-6">
                <!-- Additional branding or links could go here -->
            </div>
            <nav class="flex gap-6 items-center">
                <a href="/docs/main-product" class="text-sm font-medium text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 transition-colors">Documentation</a>
                <a href="/privacy-policy" class="text-sm font-medium text-gray-600 hover:text-black dark:text-gray-400 dark:hover:text-white transition-colors">Privacy Policy</a>
                <a href="/terms-and-conditions" class="text-sm font-medium text-gray-600 hover:text-black dark:text-gray-400 dark:hover:text-white transition-colors">Terms & Conditions</a>
                <a href="/about-us" class="text-sm font-medium text-gray-600 hover:text-black dark:text-gray-400 dark:hover:text-white transition-colors">About Us</a>
            </nav>
        </header>
        ...
        <div class="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-12 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
                >
        ...
        <footer class="mt-auto w-full py-6 text-center text-sm text-gray-500 dark:text-gray-400">
            <div class="flex justify-center gap-6 mb-2">
                <a href="/privacy-policy" class="hover:text-red-600 dark:hover:text-red-500 transition-colors">Privacy Policy</a>
                <a href="/terms-and-conditions" class="hover:text-red-600 dark:hover:text-red-500 transition-colors">Terms & Conditions</a>
                <a href="/about-us" class="hover:text-red-600 dark:hover:text-red-500 transition-colors">About Us</a>
            </div>
            <p>&copy; {{ new Date().getFullYear() }} Laravel. All rights reserved.</p>
        </footer>
    </div>
</template>
